...
namespace Figure {
	...
	*/
	...
	private:
		...
		/// <summary>
		/// Spiral vertex matrix.
		/// </summary>
		array<double, 2> ^spiralMatrixVert;

		/// <summary>
		/// Spiral face matrix.
		/// </summary>
		array<int, 2> ^spiralMatrixFace;
...
private: System::Windows::Forms::Button^  buttonNewTor;
private: System::Windows::Forms::Button^  buttonNewSpiral;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->buttonNewTor = (gcnew System::Windows::Forms::Button());
			this->buttonNewSpiral = (gcnew System::Windows::Forms::Button());
			...
			// buttonNewTor
			// 
			this->buttonNewTor->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 11.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->buttonNewTor->Location = System::Drawing::Point(860, 276);
			this->buttonNewTor->Name = L"buttonNewTor";
			this->buttonNewTor->Size = System::Drawing::Size(172, 34);
			this->buttonNewTor->TabIndex = 28;
			this->buttonNewTor->Text = L"Новый тор";
			this->buttonNewTor->UseVisualStyleBackColor = true;
			this->buttonNewTor->Click += gcnew System::EventHandler(this, &FiguForm::buttonNewTor_Click);
			// 
			// buttonNewSpiral
			// 
			this->buttonNewSpiral->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 11.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->buttonNewSpiral->Location = System::Drawing::Point(860, 316);
			this->buttonNewSpiral->Name = L"buttonNewSpiral";
			this->buttonNewSpiral->Size = System::Drawing::Size(172, 34);
			this->buttonNewSpiral->TabIndex = 29;
			this->buttonNewSpiral->Text = L"Новая спираль";
			this->buttonNewSpiral->UseVisualStyleBackColor = true;
			this->buttonNewSpiral->Click += gcnew System::EventHandler(this, &FiguForm::buttonNewSpiral_Click);
			// 
			// buttonNewIco
			// 
			...
			this->Controls->Add(this->buttonNewSpiral);
			this->Controls->Add(this->buttonNewTor);
			...
			this->Text = L"3D моделирование - 2";
...
private: System::Void buttonOrtProj_Click(System::Object^  sender, System::EventArgs^  e) {
	...
	drawFigure(pictureBoxFigure, matrixComposition(matrixVert, matrixCurrProj), matrixFace); // drawing
}
...
private: System::Void buttonDemo_Click(System::Object^  sender, System::EventArgs^  e) {
	...
	matrixVert = matrixComposition(matrixVert, formYRotateMatrix(0.3)); // rotating
	matrixVert = matrixComposition(matrixVert, formMoveMatrix(pictureBoxFigure->Width / 2, pictureBoxFigure->Height / 2, 0)); // moving
	drawFigure(pictureBoxFigure, matrixComposition(matrixVert, matrixCurrProj), matrixFace); // drawing 1
	...
	drawFigure(pictureBoxFigure, matrixComposition(matrixCopy, matrixCurrProj), matrixFace); // drawing 2
...
private: System::Void buttonNewTor_Click(System::Object^  sender, System::EventArgs^  e) {
	clearPictureBox(pictureBoxFigure); // clearing
	defaultMatrixVert = torMatrixVert; // setting tor
	defaultMatrixFace = torMatrixFace; // setting tor
	state = -1;
	// draws initial figure
	drawInitialFigure();
}
private: System::Void buttonNewSpiral_Click(System::Object^  sender, System::EventArgs^  e) {
	clearPictureBox(pictureBoxFigure); // clearing
	defaultMatrixVert = spiralMatrixVert; // setting spiral
	defaultMatrixFace = spiralMatrixFace; // setting spiral
	state = -1;
	buttonFrontProj_Click(nullptr, nullptr); // rotating
}
...
private: System::Void оПрограммеToolStripMenuItem_Click(System::Object^  sender, System::EventArgs^  e) {
	MessageBox::Show(this, "Программа предназначена для демонстрации различных фигур и их трансформаций.\n\n" +
		"1) Реализованы такие фигуры, как: \n" +
		"\tтетраэдр, октаэдр, икосаэдр;\n" +
		"\tсфера, фрукт (P.S. Груша - тоже фрукт. Прошу не карать. Дополнительно реализовал эллипсоид);\n" +
		"\tтор, спираль.\n\n" +
		...
		"Среда разработки: Visual Studio 2013\n" +
		"Дата: 28.10.2015", "О программе", MessageBoxButtons::OK);
