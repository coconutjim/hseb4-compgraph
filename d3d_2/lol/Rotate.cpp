...
HRESULT InitWindow(HINSTANCE hInstance, int nCmdShow)
{
	...
	g_hWnd = CreateWindow(
		L"SimpleWindowClass",
		L"DirectX 10: Анимируем треугольник",
		WS_OVERLAPPEDWINDOW,
		CW_USEDEFAULT,
		CW_USEDEFAULT,
		WINDOW_WIDTH,
...
HRESULT InitDirect3D10()
{
	...
	hr = D3DX10CreateEffectFromFile(L"rotate.fx", NULL, NULL, "fx_4_0", D3D10_SHADER_ENABLE_STRICTNESS, 0,
...
void RenderScene()
{
	...
	//(компоненты красного, зелеого, синего, прозрачность)
