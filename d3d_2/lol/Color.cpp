//--------------------------------------------------------------------------------------
//  Вращающийся треугольник с цветными вершинами
//--------------------------------------------------------------------------------------
...
HRESULT InitWindow(HINSTANCE hInstance, int nCmdShow)
{
	...
	g_hWnd = CreateWindow(
		L"SimpleWindowClass",
		L"DirectX 10: Рисуем треугольник в цвете",
		WS_OVERLAPPEDWINDOW,
		CW_USEDEFAULT,
		CW_USEDEFAULT,
		WINDOW_WIDTH,
...
HRESULT InitDirect3D10()
{
	...
	// в файле эффектов color.fx
	hr = D3DX10CreateEffectFromFile(L"color.fx", NULL, NULL, "fx_4_0", D3D10_SHADER_ENABLE_STRICTNESS, 0,
	...
	D3DXMatrixPerspectiveFovLH(&g_Projection, (float)D3DX_PI / 4, width / (float)height, 0.1f, 100.0f);
