...
const int vertices_count = sphere_vcount + tor_vcount + 12;
const int indices_count = sphere_icount + tor_icount + 12;
...
void RenderScene()
{
 ...
 // Рисуем нашу сцену
	...
	g_pd3dDevice->DrawIndexed(12, tor_icount + sphere_icount, 0); // for pyramidЦ
	// Переключаем буферы
