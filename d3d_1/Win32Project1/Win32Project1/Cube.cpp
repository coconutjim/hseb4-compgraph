...
HRESULT InitDirect3D10()
{
	...
	hr = D3DX10CreateEffectFromFile(L"Cube.fx", NULL, NULL, "fx_4_0", D3D10_SHADER_ENABLE_STRICTNESS, 0,
     ...
     SimpleVertex vertices[] =
    {
		...
		{ D3DXVECTOR3(-1.0f, 1.0f, -1.0f),	D3DXVECTOR4(1.0f, 1.0f, 1.0f, 1.0f) },// 1 //Желтая верхняя грань
		{ D3DXVECTOR3(1.0f, 1.0f, -1.0f),	D3DXVECTOR4(1.0f, 1.0f, 1.0f, 1.0f) },// 2
		{ D3DXVECTOR3(1.0f, 1.0f, 1.0f),	D3DXVECTOR4(1.0f, 1.0f, 1.0f, 1.0f) },// 3
		{ D3DXVECTOR3(-1.0f, 1.0f, 1.0f),	D3DXVECTOR4(1.0f, 1.0f, 1.0f, 1.0f) },// 4

		{ D3DXVECTOR3(-1.0f, -1.0f, -1.0f), D3DXVECTOR4(1.0f, 0.0f, 0.0f, 1.0f) },// 5 //Красная нижняя грань
		{ D3DXVECTOR3(1.0f, -1.0f, -1.0f), D3DXVECTOR4(1.0f, 0.0f, 0.0f, 1.0f) },// 6
		{ D3DXVECTOR3(1.0f, -1.0f, 1.0f), D3DXVECTOR4(1.0f, 0.0f, 0.0f, 1.0f) },// 7
		{ D3DXVECTOR3(-1.0f, -1.0f, 1.0f), D3DXVECTOR4(1.0f, 0.0f, 0.0f, 1.0f) },// 8

		{ D3DXVECTOR3(-1.0f, -1.0f, 1.0f), D3DXVECTOR4(0.2f, 0.0f, 0.0f, 1.0f) },// 8 //Коричневая левая грань
		{ D3DXVECTOR3(-1.0f, -1.0f, -1.0f), D3DXVECTOR4(0.2f, 0.0f, 0.0f, 1.0f) },// 5
		{ D3DXVECTOR3(-1.0f, 1.0f, -1.0f), D3DXVECTOR4(0.2f, 0.0f, 0.0f, 1.0f) },// 1
		{ D3DXVECTOR3(-1.0f, 1.0f, 1.0f), D3DXVECTOR4(0.2f, 0.0f, 0.0f, 1.0f) },// 4

		{ D3DXVECTOR3(1.0f, -1.0f, 1.0f), D3DXVECTOR4(0.8f, 0.5f, 0.6f, 1.0f) },// 7 // Оранжевая правая грань
		{ D3DXVECTOR3(1.0f, -1.0f, -1.0f), D3DXVECTOR4(0.8f, 0.5f, 0.6f, 1.0f) },// 6
		{ D3DXVECTOR3(1.0f, 1.0f, -1.0f), D3DXVECTOR4(0.8f, 0.5f, 0.6f, 1.0f) },// 2
		{ D3DXVECTOR3(1.0f, 1.0f, 1.0f), D3DXVECTOR4(0.8f, 0.5f, 0.6f, 1.0f) },// 3

		{ D3DXVECTOR3(-1.0f, -1.0f, -1.0f), D3DXVECTOR4(0.1f, 0.2f, 0.2f, 1.0f) },// 5 //Темно зеленая грань
		{ D3DXVECTOR3(1.0f, -1.0f, -1.0f), D3DXVECTOR4(0.1f, 0.2f, 0.2f, 1.0f) },// 6
		{ D3DXVECTOR3(1.0f, 1.0f, -1.0f), D3DXVECTOR4(0.1f, 0.2f, 0.2f, 1.0f) },// 2
		{ D3DXVECTOR3(-1.0f, 1.0f, -1.0f), D3DXVECTOR4(0.1f, 0.2f, 0.2f, 1.0f) },// 1

		{ D3DXVECTOR3(-1.0f, -1.0f, 1.0f), D3DXVECTOR4(0.1f, 0.6f, 0.6f, 1.0f) },// 8 //Светло зеленая грань
		{ D3DXVECTOR3(1.0f, -1.0f, 1.0f), D3DXVECTOR4(0.1f, 0.6f, 0.6f, 1.0f) },// 7
		{ D3DXVECTOR3(1.0f, 1.0f, 1.0f), D3DXVECTOR4(0.1f, 0.6f, 0.6f, 1.0f) },// 3
		{ D3DXVECTOR3(-1.0f, 1.0f, 1.0f), D3DXVECTOR4(0.1f, 0.6f, 0.6f, 1.0f) },// 4
    ...
    bd.Usage = D3D10_USAGE_DEFAULT;
    bd.ByteWidth = sizeof( DWORD ) * 36;// нужно 36 вершин для 12 треугольников
